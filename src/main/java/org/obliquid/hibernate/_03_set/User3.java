...
public class User3 {
         ...
         */
        //With @JoinTable annotation we can define  table name and join column name
        @ElementCollection
        @JoinTable(name = "user3_address", joinColumns = @JoinColumn(name = "user3_id")) // this is not mandatory
