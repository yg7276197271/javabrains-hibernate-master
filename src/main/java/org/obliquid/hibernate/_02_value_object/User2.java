...
public class User2 {
		...
		//@EmbeddedId  -> for Embedded object as primary key
        private int userId;
        ...
        @Embedded
        @AttributeOverrides({
            @AttributeOverride(name = "street", column = @Column(name = "office_stret")),
            @AttributeOverride(name = "city", column = @Column(name = "office_city")),
            @AttributeOverride(name = "state", column = @Column(name = "office_state")),
            @AttributeOverride(name = "postCode", column = @Column(name = "office_post_code"))
        })
